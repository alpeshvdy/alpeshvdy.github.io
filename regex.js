...
var value = document.getElementsByClassName("iUh30 bc tjvcx");
for (x = 0; x < value.length; x++) { 
for (y = 0; y < URLs.length; y++){
for (z = 0; z < value[x].textContent.split(" ").length; z++){

    if (value[x].textContent.split(" ")[z] == URLs[y]){
        value[x].parentElement.parentElement.parentElement.parentElement.innerHTML = "<cite class='iUh30 bc tjvcx'></cite>";
